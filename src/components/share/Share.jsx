  ...
  return (
    ...
    <div className="shareWrapper">
      <div className="shareTop">
        ...
        <input
          placeholder={"Whats Up " +  user.username + "?"} 
      ...
      <form className="shareBottom" onSubmit={submitHandler}>
          <div className="shareOptions">
              <label htmlFor="file" className="shareOption">
                  ...
                  {/* Share pics type and one only at a time  */}
                  <span className="shareOptionText">Snaps</span>
                  <input
                style={{ display: "none" }}type="file" id="file" accept=".png,.jpeg,.jpg"
